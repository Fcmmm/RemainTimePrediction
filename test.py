...
class InputData():
    ...
    def initData(self,data_address):
        ...
        print("ogrinal_data:",record)
        # print("orginal_trace:",orginal_trace)
        # print("orginal_trace_len:",len(orginal_trace))
...
if __name__ == '__main__':
    data = InputData('data/Codeforces 936_15.csv', embd_dimension = 3, time_unit = 'minute')
    # data.initData('data/Codeforces 936_15.csv')
    # data.encodeTrace()
    # data.splitData(train_splitThreshold=0.7)
    # data.initBatchData('minute', 1)
    # data.initBatchData_tuijian('minute',1)
    # print(read_csv('data/codeforces 948_4.csv'))
    # data.encodeEventByVocab(vector_address='./vector/codeforces 936_15_vectors_2CBoW_noTime_noEnd_Vector_vLoss_v1.txt',
    #                          vocab_address='./vector/codeforces 936_15_2CBoW_noTime_noEnd_vocabulary.txt')
    # data.encodeTrace()
    # data.splitData(train_splitThreshold=0.7)
    # data.initBatchData('minute', 1)
    # data.generateMixLengthBatch(20)
    # print(data.train_batch)
    # for (input, target) in data.train_batch:
    #     print(input,target)
    # data.generateSingleLengthBatch(16,1)
    # data.generateMixLengthBatch(32)
    # print(data.train_batch)
    # print(data.embd_dimension)
    # print(trainVector.data)
# 15087   训练集10560   测试集4527
#     print(data.train_dataset)
#     print(data.train_singleLengthData)
#     print(data.initBatchData())
#     eventlog = 'Codeforces 936_15'
#     data = trainVector_GloVe.readcsv(eventlog + '.csv')
#     dim = 3
#     window_size = 1
#     vocabulary = trainVector_GloVe.makeVocabulary(data, eventlog)
#     data_merge, data_new, time_code_temp, vocabulary_num, vocabulary = trainVector_GloVe.processData(data, vocabulary, eventlog)
#     cooccurrence_matrix = trainVector_GloVe.build_cooccurrence_matrix(data_merge, vocabulary_num, window_size)
#     # print(cooccurrence_matrix)
#     print(prepare_training_data(cooccurrence_matrix))
    pass
